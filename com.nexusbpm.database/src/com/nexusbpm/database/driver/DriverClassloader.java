...
public class DriverClassloader extends URLClassLoader {
    ...
    public static synchronized Connection getConnection(SQLDriver driver, String uri, String username, String password) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
        return getConnection(driver.getDriverClassName(), uri, username, password);
    }
    
    public static synchronized Connection getConnection(String driver, String uri, String username, String password) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
    ...
    public static synchronized Driver getDriver(SQLDriver driver) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
        return getDriver(driver.getDriverClassName());
    }
    
    public static synchronized Driver getDriver(String driver) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
        DriverClassloader loader = getInstance();
